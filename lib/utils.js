...
const PROJECTS_FILES = ['projects.json', 'projects_cache_git.json'];
...
function getSubtitle(project) {
  return expandHomePath(project.rootPath? project.rootPath : project.fullPath);
}
...
function getIcon(project) {
  ...
  const iconPaths = project.paths? project
    .paths
...
function getProjectFilePath() {
  return PROJECTS_FILES.map(PROJECTS_FILE => {
    let appdata;
